...
export default function DesignDashboard() {
    return (
        <div className="w-full flex">
            {/* design side bar */}
            <div className="flex-1 p-4 bg-[#f1f0ee] rounded-xl shadow-md">
            ...
            {/* Main design */}
            <div className="flex-4 p-10 overflow-y-auto bg-[#f1f0ee]">
                <h1 className="text-3xl font-bold mb-8">Header</h1>
