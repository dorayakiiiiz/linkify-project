                                                    ...
                                                    >
                                                        {(provided, snapshot) => (
                                                            <div
                                                                ...
                                                                className={`${link.moderationStatus === 'flagged' ? 'bg-[#fafafa]' : 'bg-white'} px-4 py-6 rounded-3xl shadow-md flex items-center gap-4`}
                                                            >
                                                                {/* ::: */}
                                                                <div
                                                                        ...
                                                                        <div className="grow min-w-0">
                                                                            <div className="flex items-center mb-1 justify-between">
                                                                                <div className="flex items-center">
                                                                                    <div className={`text-lg font-bold ${link.moderationStatus === 'flagged' ? "text-red-600" : "text-gray-800"}`}>
                                                                                        {link.title}
                                                                                    </div>
                                                                                    {link.moderationStatus === 'approved' && link.isEnable && (
                                                                                        <div className="w-2 h-2 rounded-full bg-green-500 animate-pulse ml-2.5"></div>
                                                                                    )}
                                                                                    {link.moderationStatus === 'pending' && (
                                                                                        <span className="ml-2.5 px-2 py-0.5 text-[11px] font-semibold bg-amber-50 text-amber-700 border border-amber-200 rounded-full flex items-center gap-1 shrink-0">
                                                                                ...
                                                                                <div className="flex items-center gap-3">
                                                                                    ...
                                                                                    <label className={`relative inline-flex items-center ${link.moderationStatus !== 'approved' ? 'cursor-not-allowed opacity-60' : 'cursor-pointer'}`}>
                                                                                        <input
                                                                                            type="checkbox"
                                                                                            className="sr-only peer"
                                                                                            checked={link.isEnable}
                                                                                            disabled={link.moderationStatus !== 'approved'}
                                                                                            onChange={() =>
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            title={link.moderationStatus === 'pending' ? 'Pending AI moderation review' : 'Enable/Disable'}
                                                                                        ></div>
                                                                                    </label>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            {link.moderationStatus === 'pending' && (
                                                                                <div className="mt-2 bg-amber-50 px-3 py-2 border border-amber-200 rounded-lg flex items-center gap-3 mr-10">
                                                                                    <i className="fa-solid fa-hourglass-half text-amber-600 text-sm"></i>
                                                                                    <div>
                                                                                        <p className="font-bold text-amber-700 text-xs md:text-sm">
                                                                                            Under AI Review
                                                                                        </p>
                                                                                        <p className="text-[12px] text-amber-600">
                                                                                            Content is currently being moderated. Toggle will be available once approved.
                                                                                        </p>
                                                                                    </div>
                                                                                </div>
                                                                            )}
