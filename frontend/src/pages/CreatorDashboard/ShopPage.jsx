                                                                ...
                                                                <div className="grow min-w-0">
                                                                    <div className="flex justify-between items-stretch">
                                                                            ...
                                                                            <div className="grow min-w-0">
                                                                                <div className="flex items-center mb-1 flex-wrap gap-1">
                                                                                    ...
                                                                                    {product.moderationStatus === 'pending' && (
                                                                                        <span className="ml-2 px-2 py-0.5 text-[11px] font-semibold bg-amber-50 text-amber-700 border border-amber-200 rounded-full inline-flex items-center gap-1 shrink-0">
                                                                                ...
                                                                                {product.moderationStatus === 'pending' && (
                                                                                    <div className="my-2 bg-amber-50 border border-amber-200 rounded-lg px-3 py-2 flex items-center gap-3">
                                                                                        <i className="fa-solid fa-hourglass-half text-amber-600 text-sm"></i>
                                                                                        <div>
                                                                                            <p className="font-bold text-amber-700 text-xs md:text-sm">Under AI Review</p>
                                                                                            <p className="text-[12px] text-amber-600">
                                                                                                Content is being moderated by AI. Toggle will be unlocked upon approval.
                                                                                            </p>
                                                                                        </div>
                                                                                    </div>
                                                                                )}
                                                                                    ...
                                                                                    <div className="my-2 bg-red-50 border border-red-200 rounded-lg px-3 py-2 flex items-center gap-3">
                                                                                        ...
                                                                                        <div>
                                                                                            ...
                                                                                            <p className="text-[12px] text-red-600">
                                                                                                Reason: {product.violationReason || 'Community Guidelines'}. This product is disabled.
                                                                                            </p>
                                                                                        </div>
                                                                                    </div>
                                                                                )}
                                                                        ...
                                                                        <div className="flex flex-col justify-between items-center">
                                                                            <label className={`relative inline-flex items-center ${product.moderationStatus !== 'approved' ? 'cursor-not-allowed opacity-60' : 'cursor-pointer'}`}>
                                                                                <input
                                                                                    type="checkbox"
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    title={product.moderationStatus === 'pending' ? 'Pending AI moderation review' : 'Enable/Disable'}
                                                                                ></div>
                                                                            </label>
