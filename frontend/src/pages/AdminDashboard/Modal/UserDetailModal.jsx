                                ...
                                <div className="border rounded-xl overflow-auto max-h-[500px]">
                                    <table className="w-full text-sm text-left">
                                        ...
                                        <tbody className="divide-y divide-gray-100">
                                            {data.links.map(link => (
                                                <tr key={link._id} className={link.moderationStatus === 'flagged' ? 'bg-red-50' : link.moderationStatus === 'pending' ? 'bg-amber-50' : ''}>
                                    ...
                                    <table className="w-full text-sm text-left">
                                        ...
                                        <tbody className="divide-y divide-gray-100">
                                            {data.products && data.products.map(item => (
                                                <tr key={item._id} className={item.moderationStatus === 'flagged' ? 'bg-red-50' : item.moderationStatus === 'pending' ? 'bg-amber-50' : ''}>
                                                    ...
                                                    <td className="px-4 py-3">
                                                        {item.deletedBy === 'admin' ? (
                                                            ...
                                                            <span className="text-amber-600 font-bold text-xs flex items-center gap-1"><i className="fa-solid fa-spinner animate-spin"></i> Pending Review</span>
                                                        ) : (
                                                            <span className="text-green-600 font-bold text-xs">Safe</span>
                                                        )}
                                                    </td>
