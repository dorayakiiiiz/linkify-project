                                ...
                                <div key={item._id} className="group relative border border-gray-300 rounded-xl p-4 flex justify-between items-center bg-white hover:border-blue-400 hover:shadow-sm transition-all duration-200">
                                    ...
                                    <div className="flex gap-2 shrink-0 ml-4">
                                        <button 
                                            ...
                                            disabled={item.moderationStatus === 'flagged'} // Disable nếu vi phạm
                                            className={`w-9 h-9 flex items-center justify-center rounded-xl border transition-all ${item.moderationStatus === 'flagged' ? 'opacity-20 cursor-not-allowed bg-slate-50 border-slate-200' : 'bg-white border-green-100 text-green-600 hover:bg-green-600 hover:text-white hover:shadow-lg hover:shadow-green-200 active:scale-90'}`}
                                            title="Restore"
                                        >
